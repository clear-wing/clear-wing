...
## About the site
This is a personal website of LiWenbo, created with github and jekyll. 
Create your own website is as easy as clone or fork a [template](https://github.com/clear-wing/clear-wing.github.io) on github, and [commit](http://jekyllrb.com/docs/posts/) to `_posts` folder. 
